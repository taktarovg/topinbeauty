// // src/app/api/auth/telegram/route.ts - update
...
//         const userData = {
//             telegramId: data.id.toString(), // Преобразуем id в строку для telegramId
...
//                     data: {
//                         ...userData,
//                         role: 'USER', // Используем строковое значение вместо enum
//                         isPremium: false
//                     },
//                 })
