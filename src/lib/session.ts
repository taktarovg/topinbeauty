...
import { cookies } from 'next/headers'; // Обновляем импорт для использования cookies из next/headers
import { prisma } from './prisma'; // Добавляем импорт Prisma для поиска пользователя
